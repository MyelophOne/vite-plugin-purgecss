...
describe('purgecss safelist standard option', () => {
	...
	it('finds safelisted selectors', () => {
		findInCss(['.random', 'h1', '#yep', 'button', '.nav-blue', '.nav-red', '[data-v-test]'], output)
	})
})
...
describe('purgecss safelist deep option', () => {
	...
	it('finds safelisted selectors', () => {
		findInCss(['.card', '.card .content', '.btn', '.card .btn .yellow'], output)
	})
...
describe('purgecss safelist greedy option', () => {
	...
	it('finds safelisted selectors', () => {
		findInCss(
			['.card', '.card[data-v-test]', '.card[data-v-test].card--large', '.card[data-v-test] .card-content'],
			output
		)
	})
...
describe('purgecss safelist keyframes option', () => {
	...
	it('finds safelisted keyframes', () => {
		findInCss(['@keyframes scale', '@keyframes scale-down', '@keyframes spin'], output)
	})
